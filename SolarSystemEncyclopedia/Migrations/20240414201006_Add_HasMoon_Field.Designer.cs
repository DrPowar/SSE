...
namespace SolarSystemEncyclopedia.Migrations
{
    ...
    [Migration("20240414201006_Add_HasMoon_Field")]
    partial class Add_HasMoon_Field
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SolarSystemEncyclopedia.Models.Planet", b =>
                {
                    ...
                    b.Property<bool>("HasMoon")
                        .HasColumnType("tinyint(1)");

                    b.Property<int>("MainStarId")
                        .HasColumnType("int")
                        .HasColumnName("MainStarId1");

                    b.HasIndex("MainStarId");
